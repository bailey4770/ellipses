...
Figure 2 does, however, show the ellipse rotated about the Y-axis. This is the
...
<figure>
  ...
  <figcaption>Figure 3: An orthographic projection of an elliptical orbit in three dimensions from the side, with labeled inclination $i$. In this figure, $i = \frac{\pi}{6}$ radians. (Source: Own diagram)</figcaption>
</figure>
...
the X-axis aligned with the line of nodes. The Y-axis is then the only possible
remaining direction which is orthogonal to both the Z- and X-axes.
